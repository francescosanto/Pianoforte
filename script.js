...
const TRANSLATIONS = {
    es: {
        ...
        chi_sono_p6: 'En el pasado estudié Física en la Universidad de Bolonia y trabajé como ingeniero informático. Impulsado por mis sueños, elegí dedicarme a tiempo completo a la música, ocupándome también de producción musical, mixing y mastering, además del estudio del instrumento. Me diplomé en producción musical e ingeniería de audio con la máxima calificación en el instituto NAM de Milán.',
        chi_sono_p7: 'Hablo italiano, inglés y español y estoy disponible para desplazarme. Si buscas un pianista capaz de unir profesionalidad, emoción y versatilidad, estaré encantado de colaborar contigo.',
    ...
    en: {
        ...
        chi_sono_p6: 'In the past I studied Physics at the University of Bologna and worked as a computer engineer. Driven by my dreams, I chose to devote myself full-time to music, also dealing with music production, mixing and mastering, as well as studying the instrument. I graduated in music production and audio engineering with top marks from the NAM institute in Milan.',
        chi_sono_p7: 'I speak Italian, English and Spanish and I am available to travel. If you\'re looking for a pianist who can combine professionalism, emotion and versatility, I\'ll be happy to collaborate with you.',
        repertoire_jazz: 'Jazz Standards',
    ...
    it: {
        ...
        chi_sono_p6: 'In passato ho studiato Fisica all\'Università di Bologna e ho lavorato come ingegnere informatico. Spinto dai miei sogni, ho scelto di dedicarmi a tempo pieno alla musica, occupandomi anche di produzione musicale, mixing e mastering, oltre allo studio dello strumento. Mi sono diplomato in produzione musicale e ingegneria audio con il massimo dei voti presso l\'istituto NAM di Milano.',
        chi_sono_p7: 'Parlo italiano, inglese e spagnolo e sono disponibile a spostarmi. Se cerchi un pianista capace di unire professionalità, emozione e versatilità, sarò felice di collaborare con te.',
        repertoire_jazz: 'Jazz Standards',
